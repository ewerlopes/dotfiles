...
Org capture is an amazing tool for taking quick notes, be it simple text, links, resources, or reminders. They are all organised in specified org files which are described below.
